...
class TestWorkoutLogManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user = self.user_manager.create_user_profile("workoutUser", "password", "workout bio")
    ...
    def test_create_workout_log(self):
        ...
        workout_log = self.workout_log_manager.create_workout_log(self.user.username, "Cardio Session")
